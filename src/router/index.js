...
export const asyncRoutes = [
  ...
  },
  {
    ...
    name: 'Example',
    meta: { title: '示例', icon: 'example', roles: ['admin'] },
    children: [
      {
        path: 'table',
        name: 'Table',
      ...
      },
      {
        ...
        meta: { title: '树状', icon: 'tree', roles: ['admin'] }
      }
    ]
  },
